...
void animate::update(){
    ...
    if (mouseIn){
        ...
        sidebar[SB_MOUSE_POSITION] = "(" + to_string(system.get_min_domain()) +
                ", " + to_string(system.get_max_domain()) + ")";
                //mouse_pos_string(window);
        sidebar[SB_EQUATION] = "y=" + system.get_equation();
   ...
   while (window.pollEvent(event))//or waitEvent
       ...
       // check the type of the event...
           ...
           case sf::Event::TextEntered:
               ...
               //this does not work
//               if (function_in){
//                    cout << "DEBUG: Function in!!!" << endl;
//                    if (event.text.unicode < 128){
//                        function_input += static_cast<char>(event.text.unicode);
//                        function_text.setString(function_input);
//                    }
//                 }
           ...
           case sf::Event::KeyPressed:
               switch(event.key.code){
                case sf::Keyboard::Left:
                   sidebar[SB_KEY_PRESSED] = "LEFT PENDING";
                   command = 1;
                   break;
               case sf::Keyboard::Right:
                   sidebar[SB_KEY_PRESSED] = "RIGHT PENDING";
                   command = 2;
                   break;
               case sf::Keyboard::I:
               ...
               case sf::Keyboard::O:
                   ...
                   break;
               case sf::Keyboard::F:
                   sidebar[SB_KEY_PRESSED] = "EQUATION IN";
                   function_in =true;
                   command = 5;
                   break;
